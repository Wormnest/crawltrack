...
$language['user_setup']="Voer gebruikers login and wachtwoord in.";
$language['user_site_creation']="Gebruikers account set-up";
$language['user_site_setup']="Voer gebruikers login and wachtwoord in.";
$language['admin_rights']="De beheerder heeft toegang tot alle statistieken en set-up gegevens.";
$language['login']="Gebruiker";
...
//1.4.0
$language['time_set_up']="Tijd verschil tussen server en u";
$language['server_time']="Server datum en tijd =";
$language['local_time']="Lokale datum en tijd =";
$language['time_difference']="Verschil in uren tussen de server tijd en de locale tijd=";
$language['time_server']=" U gebruikt nu de server tijd. Wilt u de lokale tijd gebruiken bij het laten zien van de informatie?";
$language['time_local']="U gebruikt nu de lokale tijd. Wilt u de server tijd gebruiken bij het laten zien van de informatie?";
$language['decal_ok']="CrawlTrack gebruikt nu de lokale tijd. U kunt dit altijd weer veranderen naar de server tijd.";
$language['nodecal_ok']="CrawlTrack gebruikt nu de server tijd. U kunt dit altijd weer veranderen naar de lokale tijd.";
...
$language['set_up_mail3']="Op dit moment gebruikt u de volgende e-mail adressen:";
$language['set_up_mail4']="Voeg een adres toe";
$language['set_up_mail5']="Vul hieronder het nieuwe e-mailadres in";
