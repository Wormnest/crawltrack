...
//1.3.0
$language['use_user_agent']="Crawler detection is done by user agent or by IP. Please enter one of the two.";
...
$language['update_crawltrack_ok']="CrawlTrack update is finished. You are now using version:";
$language['table_mod_no_ok']="Crawlt_crawler table update failed.";
$language['files_mod_no_ok']="A problem occurred during configconnect.php and crawltrack.php update.";
$language['update_crawltrack_no_ok']="A problem occurred during CrawlTrack update.";
$language['no_logo']="No logo.";
//modified in 1.5.0
$language['data_suppress_ok']="The information has been successfully archived.";
$language['data_suppress_no_ok']="A problem occurred during archiving, try again.";
$language['data_suppress_validation']="Are you sure you want to archive all &nbsp;";
$language['data_suppress']="Archive the oldest information of the visits table.";
...
//1.4.0
$language['time_set_up']="Time difference between server and you";
$language['server_time']="Server date and time =";
$language['local_time']="Local date and time =";
...
$language['ip_suppress_no_ok']="A problem occurred during visits deletion, try again.";
$language['no_ip']="There is no IP record for that period.";
$language['ip_suppress_validation']="This IP has been used by different crawlers, so there is a doubt concerning the origin of these visits. Would you like to delete visits by this IP from the visits table?";
$language['ip_suppress_validation2']="Are you sure that you want to delete the visits coming from that IP?";
$language['ip_suppress_validation3']="If you want to forbid access to your site from this IP, add the following line to your .htaccess file at your site root:";
...
$language['set_up_mail']="If you want to receive a daily summary of your statistics by Email, enter your Email address.";
$language['email-address']="Email address:";
$language['address_no_ok']="The address you entered is not correct.";
$language['set_up_mail2']="The daily summary mail is turned on. Would you like to deactivate it?";
$language['update']="The setting is updated.";
...
$language['ip_no_ok']="The IP address you entered is not correct.";
...
$language['from']="from";
$language['to']="to";
$language['firstweekday-title']="Choose the first day of the week";
$language['firstweekday-set-up2']="Monday is used as the first day of the week. to Monday. Would you like to change it to Sunday?";
$language['firstweekday-set-up']="Sunday is used as the first day of the week. Would you like to change it to Monday?";
$language['01']="January";
...
$language['display_period2']="Period";
$language['visitors']="Visitors";
$language['unique_visitors']="Unique visitors";
...
$language['average_pages']="Pages viewed per visit";
$language['stats_visitors']="Visitor statistics";
$language['count_in_stats']="Don't count your own visits on the followings sites:";
$language['stats_visitors_other_domain']="If one of the sites is hosted on another server you have to copy the file crawltsetcookie.php (you will find it in the Crawltrack php folder) to the root of the site before you click on OK in order to have your choice taken into account.";
